    ...
    try:
        ...
        if action == "set":
            ...
            for it in range(iterations):
                ...
                # Stability check after reaching target
                additional_reads = 5
                target_reached = False

                def calculate_scaling_factor(intended_g_value, ReadGValue, max_conductance, alpha, beta, is_increasing=True):
                    # Region-based alpha/beta suggestions
                    if is_increasing and ReadGValue < 50e-06 and intended_g_value <= 50e-06:
                        alpha, beta = 1.0, 1.0
                    elif is_increasing and ReadGValue < 50e-06 and intended_g_value < 100e-06:
                        alpha, beta = 1.5, 1.5
                    elif is_increasing and ReadGValue < 50e-06 and intended_g_value <= 150e-06:
                    ...
                    if  len(conductance_values) >= 2 and abs(conductance_values[attempts] - conductance_values[attempts-1]) < 10.0 * 1e-06:
