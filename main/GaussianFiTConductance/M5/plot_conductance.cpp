...
void plot_conductance()
{
    ...
    ifstream infile("conductance_values1L.txt"); // Change this to your actual file name
    ...
    TLatex *text8 = new TLatex(0.18, 0.78, "V= 0.4v, PW= 100#muSec, NoP= 100 ");
    ...
    TLegendEntry *le11 = leg2->AddEntry(hist, "Conductance", "L");.q
