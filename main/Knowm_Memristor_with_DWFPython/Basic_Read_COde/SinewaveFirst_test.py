...
measurement_duration = 1  # Measurement duration in seconds
selected_memristor = 5
...
with dwf.AnalogDiscovery2() as device:
    ...
    # Set the positive power supply to 3.3V and enable it. This enables switches, without these voltage we will encounter an error.
    ...
    time.sleep(1)
    pattern[selected_memristor].setup_constant('low', start=True) #It is important to keep the sleep before
