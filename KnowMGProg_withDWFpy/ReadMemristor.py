...
def ReadMemristor(device):
    ...
    TimePeriod = 10e-03 # Time Period in seconds
    ...
    time.sleep(0.1)
    amplitude_ch0 = -0.1 # Set amplitude to 0.1v for reading G , for channel 0 ( -0.1v, pulse start from negative)
